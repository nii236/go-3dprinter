...
func (o *SchemaMigration) UpdateG(columns boil.Columns) (int64, error) {
...
func (q schemaMigrationQuery) UpdateAllG(cols M) (int64, error) {
...
// UpdateAllG updates all rows with the specified column values.
func (o SchemaMigrationSlice) UpdateAllG(cols M) (int64, error) {
...
func (o *SchemaMigration) UpsertG(updateOnConflict bool, conflictColumns []string, updateColumns, insertColumns boil.Columns) error {
...
func (o *SchemaMigration) DeleteG() (int64, error) {
...
func (q schemaMigrationQuery) DeleteAllG() (int64, error) {
...
func (o SchemaMigrationSlice) DeleteAllG() (int64, error) {
...
func (o *SchemaMigration) ReloadG() error {
	if o == nil {
		return errors.New("db: no SchemaMigration provided for reload")
	}
...
func (o *SchemaMigrationSlice) ReloadAllG() error {
	if o == nil {
		return errors.New("db: empty SchemaMigrationSlice provided for reload all")
	}
